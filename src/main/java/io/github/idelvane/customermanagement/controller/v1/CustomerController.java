...
public class CustomerController {
	...
	public ResponseEntity<Response<List<CustomerDTO>>> findAllBetweenDates(@RequestHeader(value=CustomerApiUtil.HEADER_CUSTOMER_MANAGEMENT_API_VERSION, defaultValue="${api.version}") 
